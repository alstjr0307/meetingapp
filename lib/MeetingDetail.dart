                ...
                children: [
                  ...
                  Container(
                    decoration: BoxDecoration(
                      border: Border(
                        bottom: BorderSide(
                            width: 1, color: FlexColor.barossaDarkPrimary),
                      ),
                    ),
                    child: Row(
                  ...
                  Padding(
                    ...
                    child: Card(
                      ...
                      elevation: 5,
                      color: Color.fromARGB(10, 248, 193, 189),
                      child: Padding(
                  ...
                  if (userid!=null &&!meetingdata['hubos'].contains(userid) &&
                      meetingdata['owner'] != userid &&
                      meetingdata['partner'] == null ) //다른사람 미팅, 마감 안됨, 신청 안함
                    Center(
                      child: Container(
                        child: TextButton(
                          child: Text(
                  ...
                  if (meetingdata['hubos'].contains(userid) &&
                      meetingdata['owner'] != userid) //다른사람 미팅, 마감 안됨, 신청 함
                    Center(
                      child: Container(
                        child: TextButton(
                          child: Text(
                  ...
                  if (meetingdata['hubos'].toString() == '[]' &&
                      ...
                      meetingdata['owner'] == userid) //본인 미팅, 신청자 없음, 마감 안됨
                    Center(
                  ...
                  if (meetingdata['partner']!= null)
                    if (meetingdata['partner']['id'] == userid)//본인이 선택된 미팅
                    Center(
                      child: Column(
                        children: [
                          Container(
                          ...
                          InkWell(
                            onTap: () {
                              Clipboard.setData(
                                      ClipboardData(text: meetingdata['kakao']))
                                  .then(
                                (_) {
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Row(
                                      children: [
                                        Icon(Icons.school),
                                        Text(meetingdata['partner']['school'],
                                            style: TextStyle(
                                                fontSize: 20,
                                                fontWeight: FontWeight.bold))
                                      ],
                                  ...
                                  Padding(
                                    ...
                                    child: Row(
                                      children: [
                                        if (meetingdata['partner']['verified'] == true)
                                          Icon(Icons.verified, color:Colors.blue),
                                        if (meetingdata['partner']['verified'] == true)
                                          Text('인증된 사용자입니다', style: TextStyle(color: Colors.blue, fontWeight: FontWeight.bold),),
                                        if (meetingdata['partner']['verified'] != true)
                                          Icon(Icons.warning, color: Colors.red),
                                        if (meetingdata['partner']['verified'] != true)
                                          Text('인증되지 않은 사용자입니다', style: TextStyle(color: Colors.red, fontWeight: FontWeight.bold), ),
                  ...
                  if (meetingdata['hubos'].toString() != '[]' &&
                      meetingdata['owner'] == userid) //내 미팅, 신청자 있음, 파트너 안정해짐
                    Expanded(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
            ...
            FlatButton(
              ...
              onPressed: () async {
                ...
                final responsee = await http.put(
                    Uri.http(
                        '10.0.2.2:8000', "api/v1/MeetingWrite/${widget.index.toString()}/"),
                    body: {
